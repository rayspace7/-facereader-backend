...
이마, 눈썹, 눈, 코, 입/턱 다섯 부위는 각각 재치있는 한 줄 코멘트로 풀어내. 부위마다 장점만 말하지 말고, 가끔은 장점 속에 살짝 재미있는 포인트를 섞어서 단조롭지 않게 해줘.

그리고 전체를 아우르는 "주의할 점"을 딱 하나만 만들어줘. 외모를 비하하거나 진짜로 기분 나쁠 수 있는 표현은 절대 쓰지 말고, "이런 날은 지출 조심!", "고집 부리다 손해 볼 수도" 처럼 성격·습관·운 쪽의 장난스러운 포인트로 풀어내.
...
반드시 아래 JSON 형식으로만 응답해.
{
  ...
  "forehead": "이마에 대한 한 줄 코멘트",
  "eyebrows": "눈썹에 대한 한 줄 코멘트",
  "eyes": "눈에 대한 한 줄 코멘트",
  "nose": "코에 대한 한 줄 코멘트",
  "mouth_chin": "입/턱에 대한 한 줄 코멘트",
  "caution": "전체를 아우르는 장난스러운 주의 포인트 한 문장",
